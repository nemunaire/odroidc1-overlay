...
FFMPEG_FLAG_MAP=(
		...
		mmal omx-rpi modplug:libmodplug opus:libopus libilbc librtmp ssh:libssh
...
IUSE="
	alsa doc +encode jack oss pic static-libs test v4l omx-rpi mmal
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
...
RDEPEND="
	...
	sdl? ( media-libs/libsdl[sound,video,${MULTILIB_USEDEP}] )
...
multilib_src_configure() {
	...
	use mmal && myconf+=( --enable-mmal --enable-hwaccel=h264_mmal )
	use omx-rpi && myconf+=( --enable-omx-rpi )
