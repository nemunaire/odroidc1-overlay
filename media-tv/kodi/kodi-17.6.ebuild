...
DESCRIPTION="Kodi is a free and open source media-player and entertainment hub (build for odroid-C1/C1+)"
...
IUSE="airplay alsa amlibs bluetooth bluray caps cec +css dbus debug dvd gles lcms libressl libusb lirc mysql nfs nonfree +opengl pulseaudio samba sftp systemd +system-ffmpeg test +udev udisks upnp upower vaapi vdpau webserver +X +xslt zeroconf"
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
	|| ( gles opengl )
	udev? ( !libusb )
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	amlibs? ( media-libs/aml-odroidc1 media-libs/odroidc1-mali-fb )
"
...
pkg_postinst() {
	...
	elog "An init.d-script called \"kodi\" has been installed."
